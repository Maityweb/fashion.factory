...
<body>
	...
	<div class="footer">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3">
					...
					<div class="text-white text-start" style="margin-top: 15px;font-size: 18px;font-weight: bold;font-family: Helvetica,sans-serif;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Airport Branch</div><br>
					<span style="color: #999999;font-family: Georgia, serif;letter-spacing: 0.2px;">
					B/31 2 No. Airport Gate Milanpally, Kolkata 700079, West Bengal, India</span><br><br>
					<a href="" class="phoneno" style="color:white;"><i class="fas fa-phone-alt"></i> +91  6290484032</a><br>
        ...
        © Copyright Shiraz Restaurant - by Millonhits</center>
